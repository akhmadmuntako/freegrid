...
public class JadwalPerjalanan {
    ...
    public JadwalPerjalanan(String id, String asal, String tujuan, String nomorKereta, String namaKereta, String jamBrg, String jamDtg, String tanggalBrg, String tanggalDtg, String subClass, String _class, List<String> availabilities, List<String> fares, String kotaAsal, String kotaTujuan, Integer lowestFare, Integer adultFare) {
        this.id = id;
        this.asal = asal;
        this.tujuan = tujuan;
...
//    public JadwalPerjalanan(String ID, String origin,String destination, String train_no,String train_name,
